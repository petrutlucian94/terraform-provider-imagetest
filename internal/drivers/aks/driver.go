...
func (k *driver) createPodIdentityAssociation(ctx context.Context) error {
	...
	for _, v := range k.podIdentityAssociations {
		...
		// TODO: add some inline comments to have a better overview of the
		// workflow and consider splitting this in multiple functions,
		// e.g. "setupClients", "deleteUserAssignedIdentity", "deleteRoleAssignment", etc.
